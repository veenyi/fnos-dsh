	...
	factory: (require) => {
		...
		*/
		...
		function optionLabel(option) {
			// fnos-dsh patch: 权限选项汉化（官方硬编码英文，不走 i18n）
			const zh = { "read-only": "只读", "workspace-write": "工作区写入", "full-access": "完全访问", "danger-full-access": "完全访问" };
			if (zh[option.value]) return zh[option.value];
			if (zh[option.name]) return zh[option.name];
		...
		function PermissionSelect({ value, locked, command, t }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				anchor: (0, react_jsx_runtime.jsxs)("button", {
					...
					"aria-label": t("input.accessMode", { name: current === void 0 ? permissionValueLabel(currentValue) : optionLabel(current) }),
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)("span", {
							...
							children: current === void 0 ? permissionValueLabel(currentValue) : optionLabel(current)
						}),
						(0, react_jsx_runtime.jsx)("span", {
