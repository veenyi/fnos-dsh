...
let PluginInventoryGateway = (() => {
	...
	return class PluginInventoryGateway extends _classSuper {
		...
		*/
		...
		/**
		* fnos-dsh 定制：启用/停用一个插件（loader entry）。
		* 通过 loader.update 修改 disabled，运行时立即 dispose/init，并持久化到 cordis.patch.yml。
		* @param entryId - loader entry id（list() 返回的 entryId）
		* @param enabled - 目标状态
		*/
